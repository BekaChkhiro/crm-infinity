...
import { GlobalTimeTracker } from "@/features/time-tracking/components/GlobalTimeTracker";
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {stats.averageCompletionTime}სთ
              </div>
              <p className="text-xs text-muted-foreground">Task-ის დასრულება</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">ამ თვე</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          <TabsList>
            ...
            <TabsTrigger value="timetracker">ტაიმ ჩეკერი</TabsTrigger>
